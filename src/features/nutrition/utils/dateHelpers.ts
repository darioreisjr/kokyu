...
/**
 * The local `yyyy-MM-dd` key every `PlannedMeal`/pantry expiration
 * date is stored and compared as — never a full ISO datetime, which
 * would drag timezone conversion into a plain calendar date.
 */
